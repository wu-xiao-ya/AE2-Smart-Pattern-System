...
public class PatternSearchScreen extends Screen {
    ...
    public PatternSearchScreen(PatternEditorScreen parent, PatternEditorMenu menu) {
        super(Component.translatable("gui.ae2sps.search.title"));
        this.parent = parent;
        this.menu = menu;
    }
    ...
    protected void init() {
        ...
        addSideButton(SEARCH_BUTTON_Y, SEARCH_BUTTON_U, SEARCH_BUTTON_V, "search", Component.translatable("gui.ae2sps.open_search"), ignored -> focusSearch());
        addSideButton(MOD_FILTER_BUTTON_Y, MOD_FILTER_BUTTON_U, MOD_FILTER_BUTTON_V, "mod", Component.translatable("gui.ae2sps.open_mod_filter"), ignored -> openModFilter());
    ...
    public boolean mouseScrolled(double mouseX, double mouseY, double delta) {
        ...
        this.listScroll = Mth.clamp(this.listScroll + (delta > 0 ? -1 : 1), 0, maxScroll);
        return true;
    }
    ...
    public void render(@NotNull GuiGraphics guiGraphics, int mouseX, int mouseY, float partialTick) {
        ...
        Component stat = Component.translatable("gui.ae2sps.search.matches", this.filteredEntries.size(), this.allEntries.size());
        ...
        if (hovered != null) {
            ...
            tooltip.add(Component.translatable("gui.ae2sps.search.tooltip.input", hovered.inputLabel()));
            tooltip.add(Component.translatable("gui.ae2sps.search.tooltip.output", hovered.outputLabel()));
