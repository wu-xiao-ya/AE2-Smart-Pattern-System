package com.ae2smartpatternsystem.integration.mekanism;
...
public final class MekanismGasHelper {
    ...
    private static Object gasHandlerCapability;
    private static Method itemStackGetCapabilityMethod;
    ...
    private static Method chemicalStackGetChemicalMethod;
    private static Method chemicalStackGetTextComponentMethod;
    private static Field gasRegistryField;
    private static Method gasRegistryMethod;
    private static Method registryGetKeyMethod;
    ...
    private static Method gasIsGaseousMethod;
    ...
    public static @Nullable GasStackView extractGas(ItemStack stack) {
        ...
        if (gasHandlerCapability == null
                || itemStackGetCapabilityMethod == null
        ...
        Object handler;
        try {
            handler = itemStackGetCapabilityMethod.invoke(stack, gasHandlerCapability);
        ...
        try {
            ...
            for (int tank = 0; tank < tanks; tank++) {
                ...
                if (gasStack == null || isChemicalStackEmpty(gasStack) || !isGasChemicalStack(gasStack)) {
                    continue;
                }
    ...
    public static @Nullable GasStackView extractGas(Object ingredient, long preferredAmount) {
        ...
        try {
            if (isChemicalStackEmpty(ingredient) || !isGasChemicalStack(ingredient)) {
                return null;
            }
    ...
    private static @Nullable ResourceLocation getChemicalRegistryName(Object chemical) {
        init();
        if (chemical == null || (gasRegistryField == null && gasRegistryMethod == null) || registryGetKeyMethod == null) {
            return null;
        }
        try {
            Object registry = gasRegistryField != null ? gasRegistryField.get(null) : gasRegistryMethod.invoke(null);
            if (registry == null) {
                return null;
            }
            Object key = registryGetKeyMethod.invoke(registry, chemical);
    ...
    private static @Nullable GasRenderData getRenderDataDirect(String gasId) {
        ...
        init();
        if ((gasRegistryField == null && gasRegistryMethod == null) || registryGetValueMethod == null) {
            return null;
        }
    ...
    private static boolean isGasChemicalStack(Object chemicalStack) {
        if (chemicalStack == null) {
            return false;
        }
        if (chemicalStackGetChemicalMethod == null) {
            return true;
        }
        try {
            Object chemical = chemicalStackGetChemicalMethod.invoke(chemicalStack);
            return isGasChemical(chemical);
        } catch (Exception ignored) {
            return true;
        }
    }

    private static boolean isGasChemical(Object chemical) {
        if (chemical == null) {
            return false;
        }
        if (gasIsGaseousMethod == null) {
            return true;
        }
        try {
            Object result = gasIsGaseousMethod.invoke(chemical);
            return result instanceof Boolean && (Boolean) result;
        } catch (Exception ignored) {
            return true;
        }
    ...
    private static @Nullable GasStackView extractGasFromTag(ItemStack stack) {
        ...
        while (matcher.find()) {
            ...
            if (candidate == null || candidate.isBlank() || !candidate.contains("mekanism")) {
                continue;
            }
    ...
    private static void init() {
        ...
        try {
            ...
            try {
                ...
                if (chemicalCapability != null) {
                    try {
                        Method itemMethod = chemicalCapability.getClass().getMethod("item");
                        gasHandlerCapability = itemMethod.invoke(chemicalCapability);
                    } catch (Exception ignored) {
                        gasHandlerCapability = chemicalCapability;
                    }
                }
            } catch (Exception ignored) {
                Field gasHandlerField = capabilitiesClass.getField("GAS_HANDLER");
                gasHandlerCapability = gasHandlerField.get(null);
            }
        } catch (Exception ignored) {
        ...
        if (gasHandlerCapability != null) {
            for (Method method : ItemStack.class.getMethods()) {
                if (!"getCapability".equals(method.getName()) || method.getParameterCount() != 1) {
                    continue;
                }
                if (method.getParameterTypes()[0].isAssignableFrom(gasHandlerCapability.getClass())) {
                    itemStackGetCapabilityMethod = method;
                    break;
                }
            }
        }
        ...
        try {
            Class<?> gasHandlerClass = Class.forName("mekanism.api.chemical.IChemicalHandler");
            handlerGetTanksMethod = gasHandlerClass.getMethod("getChemicalTanks");
        ...
        try {
            ...
            chemicalStackGetChemicalMethod = chemicalStackClass.getMethod("getChemical");
            chemicalStackGetTextComponentMethod = chemicalStackClass.getMethod("getTextComponent");
        } catch (Exception ignored) {
            chemicalStackIsEmptyMethod = null;
            chemicalStackGetAmountMethod = null;
            chemicalStackGetTypeRegistryNameMethod = null;
            chemicalStackGetChemicalMethod = null;
        ...
        try {
            ...
            try {
                gasRegistryField = mekanismApiClass.getField("CHEMICAL_REGISTRY");
                Object registry = gasRegistryField.get(null);
                if (registry != null) {
                    gasRegistryMethod = null;
                }
            } catch (Exception ignored) {
                gasRegistryField = null;
                gasRegistryMethod = null;
            }
            if (gasRegistryField == null && gasRegistryMethod == null) {
                try {
                    gasRegistryMethod = mekanismApiClass.getMethod("chemicalRegistry");
                } catch (Exception ignored) {
        ...
        if (gasRegistryField != null || gasRegistryMethod != null) {
            try {
                ...
                if (registry != null) {
                    try {
                        registryGetValueMethod = registry.getClass().getMethod("getValue", ResourceLocation.class);
                    } catch (Exception ignored) {
                        registryGetValueMethod = registry.getClass().getMethod("get", ResourceLocation.class);
                    }
                    try {
                        registryGetKeyMethod = registry.getClass().getMethod("getKey", Object.class);
                    } catch (Exception ignored) {
                        registryGetKeyMethod = null;
                    }
                }
            } catch (Exception ignored) {
                registryGetKeyMethod = null;
        ...
        try {
            Class<?> gasClass = Class.forName("mekanism.api.chemical.Chemical");
            ...
            gasIsGaseousMethod = gasClass.getMethod("isGaseous");
        } catch (Exception ignored) {
            try {
